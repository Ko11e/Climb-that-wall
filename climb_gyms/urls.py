...
urlpatterns = [
    ...
    path("delete-gym/<int:pk>", DeleteClimbingGymView.as_view(), name="delete_climbing_gym"),
    ...
    path("comment/delete/<int:pk>", DeleteCommentsView.as_view(), name="delete_comment"),
