...
urlpatterns = [
    path(
        "search/", 
        ClimbingGymsView.as_view(), 
        name="search_gyms"
    ),
    path(
        "create-climbing-gym/", 
        create_climbing_gym, 
        name="create_climbing_gym"
    ),
    path(
    ...
    path(
        "edit-gym/<int:pk>", 
        EditClimbingGymView.as_view(), 
        name="edit_climbing_gym"
    ),
    path(
        "edit-gym-text/<int:pk>", 
        EditGymTextView.as_view(), 
        name="edit_gym_text"
    ),
    path(
        "edit-gym-images/<int:pk>", 
        EditGymImagesView.as_view(), 
    ...
    path(
        "comment/<int:pk>",
        CreateCommentsView.as_view(), 
        name="create_comment"
    ),
    path(
        "comment/edit/<int:pk>",
        EditCommentsView.as_view(),
        name="edit_comment"
    ),
    path(
